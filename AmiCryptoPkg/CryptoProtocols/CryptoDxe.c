...
//                err = Pkcs7_return_digestType(P7Data, P7Size, (UINT8*)*Data);
                if(!err)
...
*/
            ...
            CopyGuid (&(Key->AlgGuid), &(pFwKeyHob->KeyGuid));
...
*/
        ...
        CopyGuid (&(Key->AlgGuid), &(gKey.AlgGuid));
        if(Key->Blob) {
...
// Get PRKey
    ...
    Status = DxeGetKey(NULL, &PubKeyHndl, AlgId, 0, 0);
    if(EFI_ERROR(Status))
        return Status;
...
///////////////////////////////////////////////////////////////////////////////////
// Install the MM clone of DXE Crypto protocol
////////////////////////////////////////////////////////////////////////////////////
// Main interface
   DummyHandle = NULL;
