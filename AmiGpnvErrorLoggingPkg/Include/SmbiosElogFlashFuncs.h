...
#define LOCAL_EVENT_LOG_PHY_ADDR    GPNV_ERROR_LOGGING_BASE
#define LOCAL_EVENT_LOG_LENGTH      GPNV_SIZE - 1
...
#if (LOCAL_EVENT_LOG_PHY_ADDR / LOCAL_LOGICAL_BLOCK_SIZE) != ((LOCAL_EVENT_LOG_PHY_ADDR+LOCAL_EVENT_LOG_LENGTH) / LOCAL_LOGICAL_BLOCK_SIZE)
