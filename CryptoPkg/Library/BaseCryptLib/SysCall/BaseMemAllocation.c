...
void *      
local_malloc (  //APTIOV OVERRIDE - To avoid redefinition build error
  size_t size                          //as malloc() function is already defined in StdLib
  ) 
...
void *
local_realloc (  //APTIOV OVERRIDE - To avoid redefinition build error 
  void *ptr,                     //as realloc() function is already defined in StdLib
  size_t size
  ) 
...
void 
local_free (  //APTIOV OVERRIDE - To avoid redefinition build error 
  void *ptr                    //as free() function is already defined in StdLib
  ) 
