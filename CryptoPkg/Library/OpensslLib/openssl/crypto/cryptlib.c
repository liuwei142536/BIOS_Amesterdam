...
// APTIOV OVERRIDE - To avoid the below build error in X64-GCC projects when OpenSSLX64GCC.inf is consumed.
//"`OPENSSL_ia32cap_P' referenced in section `.text.OPENSSL_cpuid_setup' of /tmp/ccP2yd9t.ltrans0.ltrans.o: defined in discarded section `COMMON' 
// of /BuildWorks/Prarthana/cfl/Build/CoffeeLake/DEBUG_GCC/X64/Build/OpensslLibX64Gcc/OUTPUT/OpensslLibX64Gcc.lib(x86_64cpuid.obj)"
