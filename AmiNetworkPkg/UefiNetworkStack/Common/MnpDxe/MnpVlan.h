...
#if(AMIRedFishVlan_SUPPORT)
extern EFI_REDFISH_VLAN_CONFIG_PROTOCOL mRedfishVlanConfigProtocolTemplate;
extern REDFISH_VLAN_CONFIG_DATA  *gParsedRedfishVlanData;
extern UINTN gNumberOfRedfishVlan;
#endif
