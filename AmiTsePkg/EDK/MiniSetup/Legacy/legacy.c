	...
	if ( submenu->SubMenuType != 1 )
	{
		...
		else	
		{
            ...
            if( PageNum == 0 )
            {
				...
				{
				    DestMax = (length / sizeof(CHAR16)) -  HiiFindStrPrintBoundary(text,(UINTN)((submenu->Width/2)-5));
                	StrCpyS( &text[HiiFindStrPrintBoundary(text,(UINTN)((submenu->Width/2)-5))], DestMax, L"...");
                }
            }else{
