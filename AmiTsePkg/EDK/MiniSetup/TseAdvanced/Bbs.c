    ...
    while( !(IsDevicePathEnd(DevPath)) )
    {
            ...
            switch(DevPath->SubType)
            {
                case MSG_ATAPI_DP:
                    ...
                    if(IsSATADevice(HDDInfo[(index-1)/2].IdentifyDrive[(index-1)%2].Raw))
                    {
                        ...
                        SPrint(BusText, MAX_DRIVE_NAME * sizeof(CHAR16), Format, PortNo);
                    }
                    else
                    {
                        switch(PortNo)
                ...
                { //Showing the SCSI device with Physical and Logical unit numbers
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME * sizeof(CHAR16), Format, PhyUnitNum, LogclUnitNum);
                }
                break;
                ...
                {// showing Fibre channel with Logical unit number and WWN
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME* sizeof(CHAR16), Format, Lun, WWN);
                }
                break;
                ...
                case MSG_1394_DP:
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME * sizeof(CHAR16), Format);
                break;
                ...
                case MSG_USB_DP:
		{
                ...
                { // I2O device with Tid
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME * sizeof(CHAR16), Format, Tid);
                }
                break;
                ...
                { // InfiniBand device with Device Id
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME* sizeof(CHAR16), Format, DeviceId);
                }
                break;
                ...
                { // network device with mac address
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME* sizeof(CHAR16), Format, Mac);
                }
                ...
                { //IPv4 Device with Logical Port number
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME* sizeof(CHAR16), Format, LocalPort);
                }
                break;
                ...
                { //UART device with Baud Rate
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME * sizeof(CHAR16), Format, BaudRate);
                }
                break;
			...
			break;
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME * sizeof(CHAR16), Format, DeviceClass);
                }
                break;
                ...
                { //for USB logical unit class devices with Logical Unit Numnber
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME* sizeof(CHAR16), Format, Lun);
                }
                break;
                ...
                { // for USB SATA devices with Port Number
                    ...
                    SPrint(BusText, MAX_DRIVE_NAME* sizeof(CHAR16), Format, PortNumber);
                }
                break;
...
VOID BBSBuildDevicePathName( CHAR16 *String, BBS_TABLE *info, UINTN index, HDD_INFO *HDDInfo )
{
    ...
    if(BusText && DevText)
    {
        SPrint(String, MAX_DRIVE_NAME* sizeof(CHAR16), L"%s %s", BusText, DevText);
    }
    else
    {
        ...
        {
            SPrint(String, MAX_DRIVE_NAME * sizeof(CHAR16), L"%s %s", BusText ? BusText : L"Unknown", DevText ? DevText : L"Unknown");
        }
    }
...
CHAR16 *GetUefiDevPathString(EFI_DEVICE_PATH_PROTOCOL *DevPath)
{
    ...
    if(BusText && DevText)
    {
        ...
        SPrint(String, (MAX_DRIVE_NAME+10) * sizeof(CHAR16), L"%s %s", BusText, DevText);
    }
    if(BusText)
    	MemFreePointer((VOID **)&BusText);
    if(DevText)
