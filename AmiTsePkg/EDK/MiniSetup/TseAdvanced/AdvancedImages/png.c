...
**/
EFI_STATUS DecodePng(unsigned char *PNGImage, UINT32 PNGImageSize)
{
...
EFI_STATUS ConvertPNGToUgaBlt( IN VOID *PNGImage, IN UINT32 PNGImageSize, IN OUT VOID **Blt, IN OUT UINTN *BltSize, OUT UINT32 *PixelHeight, OUT UINT32 *PixelWidth )
{
	...
	PNGImageSize = 0;
	Initialize();
	if (DecodePng((unsigned char*)PNGImage, PNGImageSize) == EFI_SUCCESS)        //Decodes the PNG image to convert PNG image data to RGB format
	{
