...
EFI_STATUS _OrdListMultiLIneDraw(ORD_LISTBOX_DATA *OrdList)
{
	...
	else
	{
        ...
        do
		{
            ...
            {
			    DestMax = (EfiStrLen(text1)+1) - HiiFindStrPrintBoundary(text1 ,(UINTN)(OrdList->Width- OrdList->LabelMargin -5));
               StrCpyS(&text1[HiiFindStrPrintBoundary(text1 ,(UINTN)(OrdList->Width- OrdList->LabelMargin -5))], DestMax , L"..." );
            }
