...
*/
	...
	if ( text->Text != NULL )
	{
		...
		else
		{
		    ...
		    {
	            DestMax = (text->Width) - HiiFindStrPrintBoundary(text->Text ,(UINTN)(text->Width - text->LabelMargin +1 -3)) ;
		      StrCpyS(&text->Text[HiiFindStrPrintBoundary(text->Text ,(UINTN)(text->Width - text->LabelMargin +1 -3))], DestMax, L"..." );
		    }
