...
/** @file EDKhelper.c
    This file contains wrapper functions for Memory and String manipulation.
...
{
    VOID *p=NULL;
    pBS->AllocatePool(EfiBootServicesData,AllocationSize,&p);
    if(p) 
        pBS->SetMem(p,AllocationSize,0);
    return p;
}
...
{
	return AsciiStrCmp( String, String2 );
}
...
INTN EfiStrCmp( CHAR16 *String, CHAR16 *String2 ) 
{
    return StrCmp( String, String2 );
}
