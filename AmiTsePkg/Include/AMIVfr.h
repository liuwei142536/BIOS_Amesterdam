...
#if SETUP_PASSWORD_LENGTH > 32
#define TSE_PWD_ENCRYPT_SHA512_SIZE     SETUP_PASSWORD_LENGTH
#else 
#define TSE_PWD_ENCRYPT_SHA512_SIZE     32
#endif
typedef struct _AMITSESETUP
{
    // Passwords
    UINT16  UserPassword[TSE_PWD_ENCRYPT_SHA512_SIZE];
    UINT16  AdminPassword[TSE_PWD_ENCRYPT_SHA512_SIZE];
    // AMI SilentBoot
    UINT8   AMISilentBoot;
}
AMITSESETUP;
...
// vfr compiler won't accept variable size less than password MaxSize
#if SETUP_PASSWORD_LENGTH > 24
#define TSE_PWD_ENCRYPT_SHA384_SIZE     SETUP_PASSWORD_LENGTH
#else 
#define TSE_PWD_ENCRYPT_SHA384_SIZE     24
#endif
typedef struct _AMITSESETUP
{
    // Passwords
    UINT16  UserPassword[TSE_PWD_ENCRYPT_SHA384_SIZE];
    UINT16  AdminPassword[TSE_PWD_ENCRYPT_SHA384_SIZE];
    // AMI SilentBoot
    UINT8   AMISilentBoot;
}
AMITSESETUP;
...
#if SETUP_PASSWORD_LENGTH > 20
#define TSE_PWD_ENCRYPT_SHA256_SIZE     SETUP_PASSWORD_LENGTH
#else 
#define TSE_PWD_ENCRYPT_SHA256_SIZE     20
#endif
typedef struct _AMITSESETUP
{
    // Passwords
    UINT16  UserPassword[TSE_PWD_ENCRYPT_SHA256_SIZE];
    UINT16  AdminPassword[TSE_PWD_ENCRYPT_SHA256_SIZE];
    // AMI SilentBoot
    UINT8   AMISilentBoot;
}
AMITSESETUP;
...
#if SETUP_PASSWORD_LENGTH > 20
#define TSE_PWD_ENCRYPT_SHA1_SIZE     SETUP_PASSWORD_LENGTH
#else 
#define TSE_PWD_ENCRYPT_SHA1_SIZE     20
#endif
typedef struct _AMITSESETUP
{
    // Passwords
    UINT16  UserPassword[TSE_PWD_ENCRYPT_SHA1_SIZE];
    UINT16  AdminPassword[TSE_PWD_ENCRYPT_SHA1_SIZE];
    // AMI SilentBoot
    UINT8   AMISilentBoot;
}
AMITSESETUP;
