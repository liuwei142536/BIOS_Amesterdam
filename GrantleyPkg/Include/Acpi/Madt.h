...
#define EFI_ACPI_IO_APIC_COUNT                        5
...
typedef struct {
  ...
  EFI_ACPI_2_0_PLATFORM_INTERRUPT_SOURCES_STRUCTURE     PlatformInterruptSources[
...
typedef struct {
  ...
  EFI_ACPI_3_0_LOCAL_APIC_ADDRESS_OVERRIDE_STRUCTURE    LocalApicOverride[EFI_ACPI_LOCAL_APIC_OVERRIDE_COUNT];
#endif
  ...
  EFI_ACPI_3_0_PLATFORM_INTERRUPT_SOURCES_STRUCTURE     PlatformInterruptSources[
    EFI_ACPI_PLATFORM_INTERRUPT_SOURCES_COUNT];
#endif
...
typedef struct {
...
#if EFI_ACPI_LOCAL_APIC_NMI_COUNT > 0					          // Type 0x04
  EFI_ACPI_4_0_LOCAL_APIC_NMI_STRUCTURE                 LocalApicNmi[EFI_ACPI_LOCAL_APIC_NMI_COUNT];
#endif
  ...
  EFI_ACPI_4_0_LOCAL_X2APIC_NMI_STRUCTURE X2ApicNmi[EFI_ACPI_LOCAL_X2APIC_NMI_COUNT];
#endif
