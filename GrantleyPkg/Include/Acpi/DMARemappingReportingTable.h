...
//
#define EFI_ACPI_DMAR_TABLE_FLAGS_CLEAR                     0x00
#define EFI_ACPI_DMAR_TABLE_FLAGS_INTR_REMAP_SET            0x01    // BIT0
#define EFI_ACPI_DMAR_TABLE_FLAGS_X2APIC_OPT_OUT_SET        0x02    // BIT1
typedef struct {
