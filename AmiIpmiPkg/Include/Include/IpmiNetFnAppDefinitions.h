...
typedef struct {
  ...
  UINT8          Reserved1 : 4;
  UINT8          ChannelState : 2;
  UINT8          Reserved2 : 6;
} IPMI_ENABLE_MESSAGE_CHANNEL_REQ;

typedef struct {
  UINT8          ChannelNumber : 4;
  UINT8          Reserved1 : 4;
  UINT8          ChannelState : 1;
  UINT8          Reserved2 : 7;
} IPMI_ENABLE_MESSAGE_CHANNEL_RES;
// AMI_IPMI_PORTING_END
//
...
typedef struct {
  UINT8         ChannelNumber : 4;
  UINT8         PrivilegeLevel : 4;
  UINT8         RequesterLun : 2;        //SMS LUN is 10b, Response will be available in Receive Message Queue
  UINT8         NetFn : 6;
  UINT8         CheckSum1;
  UINT8         RequesterSlaveAddress;
  UINT8         ResponderLun : 2;
  UINT8         SequenceNumber : 6;
  UINT8         Command;
  UINT8         CompletionCode;
...
#pragma pack()
//
//  Definitions for  Set System Info Parameters Command
//
#define IPMI_APP_SET_SYSTEM_INFO 0x58

//
//  Constants and Structure definitions for "Set System Info Parameters" command to follow here
//
#pragma pack(1)
...
typedef enum {
    SysInfoSetInProgress,
    SysInfoFirmwareVersion,
    SysInfoSystemName,
    SysInfoPrimaryOsName,
    SysInfoPresentOsName,
    SysInfoPresentOsVersion,
    SysInfoBmcUrl,
    SysInfoHyperviserUrl,
} SYSTEM_INFO_PARAMETER_SELECTOR;


typedef enum {
    SysInfoStateSetComplete,
    SysInfoStateSetInProgress,
    SysInfoStateCommitWrite,
    SysInfoStateReserved,
...
} EFI_SET_SYSTEM_INFO_REQUEST;

//
//  Definitions for  Get System Info Parameters Command
//
#define IPMI_APP_GET_SYSTEM_INFO 0x59

//
//  Constants and Structure definitions for "Get System Info Parameters" command to follow here
//
