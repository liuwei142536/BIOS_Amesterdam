  ...
  IN BOOLEAN                      GenerateDummySmbiosRecords )
{
    ...
    SERVER_IPMI_DEBUG ((DEBUG_INFO, "%a Entered... GenerateDummySmbiosRecords: %x\n", __FUNCTION__, GenerateDummySmbiosRecords));
    //
                ...
                if (!EFI_ERROR (Status)) {
                    ...
                    if ( CalculateCheckSum8 (TempPtr, Length) == 0 ) {
                        ...
                        if (!EFI_ERROR (Status)) {
                            ...
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "SystemManufacturer: ManufacturerString: %S\n", ManufacturerString));
                            PcdSetPtr (PcdSystemManufacturer, &SizeofBuffer, (VOID*)ManufacturerString);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "SystemManufacturer: %S\n", (CHAR16 *) PcdGetPtr (PcdSystemManufacturer)));
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            ...
                            if (!EFI_ERROR (Status)) {
                                ...
                                SERVER_IPMI_DEBUG ((DEBUG_INFO, "SystemProductName: ProductName: %S\n", ProductName));
                        ...
                        if (!EFI_ERROR (Status)) {
                            ...
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdSystemVersion: StrPtr: %S \n", StrPtr));
                            PcdSetPtr (PcdSystemVersion, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdSystemVersion: %S\n", (CHAR16 *) PcdGetPtr (PcdSystemVersion)));
                            FreePool (StrPtr);
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize (StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdSystemSerialNumber: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdSystemSerialNumber, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdSystemSerialNumber: %S\n", (CHAR16 *) PcdGetPtr (PcdSystemSerialNumber)));
                            FreePool (StrPtr);
                        }
                ...
                if (!EFI_ERROR (Status)) {
                    ...
                    if ( CalculateCheckSum8 ( TempPtr, Length ) == 0 ) {
                        ...
                        if ( AssetTagString != NULL ) {
                            ...
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "AssetTagString: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdBaseBoardAssetTag, &SizeofBuffer, (VOID*)AssetTagString);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdBaseBoardAssetTag: %S\n", (CHAR16 *) PcdGetPtr (PcdBaseBoardAssetTag)));
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize (StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdBaseBoardManufacturer: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdBaseBoardManufacturer, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdBaseBoardManufacturer: %S\n", (CHAR16 *) PcdGetPtr (PcdBaseBoardManufacturer)));
                            FreePool (StrPtr);
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize (StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdBaseBoardProductName: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdBaseBoardProductName, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdBaseBoardProductName: %S\n", (CHAR16 *) PcdGetPtr (PcdBaseBoardProductName)));
                            FreePool (StrPtr);
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize(StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdBaseBoardSerialNumber: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdBaseBoardSerialNumber, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdBaseBoardSerialNumber: %S\n", (CHAR16 *) PcdGetPtr (PcdBaseBoardSerialNumber)));
                            FreePool (StrPtr);
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize (StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdBaseBoardVersion: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdBaseBoardVersion, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdBaseBoardVersion: %S\n", (CHAR16 *) PcdGetPtr (PcdBaseBoardVersion)));
                            FreePool (StrPtr);
                        }
                    }
                }
            ...
            if (TempPtr != NULL) {
                ...
                if (!EFI_ERROR (Status)) {
                    ...
                    if ( CalculateCheckSum8 ( TempPtr, Length ) == 0 ) {
                        ...
                        SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdChassisType: %x\n", PcdGet8 (PcdChassisType) ));
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize(StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdChassisVersion: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdChassisVersion, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdChassisVersion: %S\n", (CHAR16 *) PcdGetPtr (PcdChassisVersion)));
                            FreePool (StrPtr);
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize (StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdChassisSerialNumber: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdChassisSerialNumber, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdChassisSerialNumber: %S\n", (CHAR16 *) PcdGetPtr (PcdChassisSerialNumber)));
                            FreePool (StrPtr);
                        }
                        ...
                        if ( ManufacturerString != NULL ) {
                            SizeofBuffer = StrSize (ManufacturerString);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdChassisManufacturer: ManufacturerString: %S\n", ManufacturerString));
                            PcdSetPtr (PcdChassisManufacturer, &SizeofBuffer, (VOID*)ManufacturerString);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdChassisManufacturer: %S\n", (CHAR16 *) PcdGetPtr (PcdChassisManufacturer)));
                        }
                        //
                        // Fill the AssertTag
                        //
                        if ( AssetTagString != NULL ) {
                            SizeofBuffer = StrSize (AssetTagString);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdChassisAssetTag: AssetTagString: %S\n", AssetTagString));
                            PcdSetPtr (PcdChassisAssetTag, &SizeofBuffer, (VOID*)AssetTagString);
                            SERVER_IPMI_DEBUG ((DEBUG_INFO, "PcdChassisAssetTag: %S\n", (CHAR16 *) PcdGetPtr (PcdChassisAssetTag)));
                        }
                    }
                }
                FreePool (TempPtr);
    ...
    if ((Offset > 0) && !GenerateDummySmbiosRecords) {
        SERVER_IPMI_DEBUG ((DEBUG_INFO, "Multirecord Info Area present\n"));
        do {
            ...
            if (!EFI_ERROR(Status)) {
                ...
                if ((MultiRecordHeader.RecordTypeId != MANAGEMENT_ACCESS_RECORD) && (!(MultiRecordHeader.EndofList)) ) {
                    ...
                    if ( MultiRecordHeader.RecordTypeId == MANAGEMENT_ACCESS_RECORD ) { // Management Access Record found
                        ...
                        //
                        SERVER_IPMI_DEBUG ((DEBUG_INFO, "Management Access record found\n"));
                        GetFruRedirDataSize = sizeof (UINT8); // Size of the length of FRU area to read.
                        ...
                        if (!(EFI_ERROR(Status))) {
                            if (SubRecordType == SYSTEM_UUID_SUB_RECORD_TYPE) {
                                ...
                                if ((CalculateCheckSum8 ((UINT8 *)&SystemUuidSubRecordwithChecksum, sizeof(SystemUuidSubRecordwithChecksum))) == 0) {
                                    ...
                                    //
                                    SERVER_IPMI_DEBUG ((DEBUG_INFO, "System UUID Sub Record Type found and Checksum OK!!!\n"));
        ...
        if (IsSystemUuidSubRecordType) { // Management Access Record
            ...
            SERVER_IPMI_DEBUG ((DEBUG_INFO, "UUID Size: %x\n", SizeofBuffer));
