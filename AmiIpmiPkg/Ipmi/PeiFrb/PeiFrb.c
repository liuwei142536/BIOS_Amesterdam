  ...
  IN VOID                      *Ppi )
{
    ...
    SERVER_IPMI_DEBUG ((DEBUG_INFO, "GetBootMode Status: %r BootMode: %x \n", Status, BootMode));
  ...
  IN  CONST EFI_PEI_SERVICES       **PeiServices )
{
    ...
    SERVER_IPMI_DEBUG ((DEBUG_INFO, " FrbEnabled: %x \n", FrbEnabled));
    ...
    if (FrbEnabled) {
        ...
        Status = IpmiTransportPpi->SendIpmiCommand (
                    ...
                    NULL,
                    &ResponseDataSize );
        SERVER_IPMI_DEBUG ((DEBUG_INFO, " IPMI_APP_RESET_WATCHDOG_TIMER Status: %r \n", Status));
