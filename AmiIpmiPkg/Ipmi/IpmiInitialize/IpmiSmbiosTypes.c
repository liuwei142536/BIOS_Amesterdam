...
typedef enum {
    ...
    AmiMcHostInterfaceTypeKCS           = 0x02, ///< The Keyboard Controller Style.
    AmiMcHostInterfaceType8250UART      = 0x03, ///< 8250 UART Register Compatible.
    AmiMcHostInterfaceType16450UART     = 0x04, ///< 16450 UART Register Compatible
    AmiMcHostInterfaceType16550UART     = 0x05, ///< 16550/16550A UART Register Compatible
    AmiMcHostInterfaceType16650UART     = 0x06, ///< 16650/16650A UART Register Compatible
    AmiMcHostInterfaceType16750UART     = 0x07, ///< 16750/16750A UART Register Compatible
    AmiMcHostInterfaceType16850UART     = 0x08, ///< 16850/16850A UART Register Compatible
    AmiMcHostInterfaceTypeOEM           = 0xF0, ///< OEM
...
typedef enum {
    ...
    AmiMcHostInterfaceProtocolIPMI          = 0x02, ///< IPMI : Intelligent Platform Management Interface.
    AmiMcHostInterfaceProtocolMCTP          = 0x03, ///< MCTP : Management Component Transport Protocol.
    AmiMcHostInterfaceProtocolOEM           = 0xF0, ///< OEM
...
typedef struct {
    ...
    AMI_SMBIOS_TYPE42_MC_HOST_PROTOCOL  Protocol[1];
  ...
  IN  VOID                                  *Context )
{
    ...
    if (Type38Record == NULL) {
        SERVER_IPMI_DEBUG ((DEBUG_ERROR, "Allocating Space for SmBios Type38Record fails...\n"));
        return;
    }
    ...
    SERVER_IPMI_DEBUG ((DEBUG_INFO, "gEfiBmcSelfTestLogProtocolGuid: Status:  %r\n", Status));
    ...
    if (EFI_ERROR (Status)) {
        SERVER_IPMI_DEBUG ((DEBUG_ERROR, "IpmiOemSmbiosTypesUpdateHook TYPE 38 status is %r and initializing unspecified values.\n", Status));
    ...
    DEBUG ((DEBUG_INFO, "SmbiosProtocol->Add Type38Record....  Status: %r \n", Status));
    ...
    if (Type42Record == NULL) {
        SERVER_IPMI_DEBUG ((DEBUG_ERROR, "Allocating Space for SmBios Type42Record fails...\n"));
        return;
    }
    ...
    Type42Record->SmbiosType42.Hdr.Length = sizeof (AMI_SMBIOS_TABLE_TYPE42_INSTANCE);
    ...
    Type42Record->Protocol[0].ProtocolType = AmiMcHostInterfaceProtocolIPMI;
    ...
    if (EFI_ERROR (Status)) {
        SERVER_IPMI_DEBUG ((DEBUG_ERROR, "IpmiOemSmbiosTypesUpdateHook TYPE 42 status is %r and initializing unspecified values.\n", Status));
    }
#endif
    ...
    if (EFI_ERROR (Status)) {
        SERVER_IPMI_DEBUG ((DEBUG_ERROR, "IpmiUpdateSystemInfo Status %r\n", Status));
    }
