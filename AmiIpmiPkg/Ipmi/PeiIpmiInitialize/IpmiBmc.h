...
#define AMI_PEI_IPMI_DATA_HOB_GUID \
  { \
    0xcb4d3e13, 0x1e34, 0x4373, {0x8a, 0x81, 0xe9, 0x0, 0x10, 0xf1, 0xdb, 0xa4} \
  }

extern EFI_GUID gAmiPeiIpmiDataHobGuid;
...
/**
    This structure is used to store fields needed to share IpmiInstance
    to install PeiIpmiTransportPpi. And is also used to get the Smbus2Ppi
    while sending the BMC command for SSIF.
*/

typedef struct _AMI_PEI_IPMI_DATA_HOB {
  UINTN  IpmiInstance;     ///< IpmiInstance pointer.
  UINTN  EfiPeiSmbus2Ppi;  ///< EfiPeiSmbus2Ppi pointer.
} AMI_PEI_IPMI_DATA_HOB;
