  ...
  IN  BMC_IP_BIOS_SETTINGS    BmcLanIpSetupValues )
{
    ...
    Status = gIpmiTransport->SendIpmiCommand (
                ...
                ResponseData,
                &ResponseDataSize );
    SERVER_IPMI_DEBUG ((DEBUG_INFO, " IPMI_TRANSPORT_SET_LAN_CONFIG_PARAMETERS: IpmiLanIpAddress: LanChannelNumber: %x Status: %r\n", LanChannelNumber, Status));
    ...
    Status = gIpmiTransport->SendIpmiCommand (
                ...
                ResponseData,
                &ResponseDataSize );
    SERVER_IPMI_DEBUG ((DEBUG_INFO, " IPMI_TRANSPORT_SET_LAN_CONFIG_PARAMETERS: IpmiLanSubnetMask: LanChannelNumber: %x Status: %r\n", LanChannelNumber, Status));
    ...
    Status = gIpmiTransport->SendIpmiCommand (
                ...
                ResponseData,
                &ResponseDataSize );
    SERVER_IPMI_DEBUG ((DEBUG_INFO, " IPMI_TRANSPORT_SET_LAN_CONFIG_PARAMETERS: IpmiLanDefaultGateway: LanChannelNumber: %x Status: %r\n", LanChannelNumber, Status));
    ...
    Status = gIpmiTransport->SendIpmiCommand (
                ...
                ResponseData,
                &ResponseDataSize );
    SERVER_IPMI_DEBUG ((DEBUG_INFO, " IPMI_TRANSPORT_SET_LAN_CONFIG_PARAMETERS: IpmiLanDefaultGatewayMac: LanChannelNumber: %x Status: %r\n", LanChannelNumber, Status));
  ...
  IN  UINT8      IpAddessSource )
{
    ...
    Status = gIpmiTransport->SendIpmiCommand (
                ...
                ResponseData,
                &ResponseDataSize );
    SERVER_IPMI_DEBUG ((DEBUG_INFO, " IPMI_TRANSPORT_SET_LAN_CONFIG_PARAMETERS: IpAddessSource:%x LanChannelNumber: %x Status: %r\n", IpAddessSource, LanChannelNumber, Status));
  ...
  IN EFI_SYSTEM_TABLE       *SystemTable )
{
    ...
    Status = gRT->SetVariable (
                    ...
                    &gServerMgmtConfiguration);
    SERVER_IPMI_DEBUG ((DEBUG_INFO, "HaveInvalidParameter: %XSetVariable status of ServerSetup %r \n", HaveInvalidParameter, Status));
    ...
    if (ChannelNumberBuffer[0] != 0) {
        ...
        SetIpAddressSource (ChannelNumberBuffer[0], BmcLanIp1SetupValues.BmcLan);

        // Configure Static address source parameters to BMC
        if (BmcLanIp1SetupValues.BmcLan == IpmiStaticAddress) {
            SetStaticBmcNetworkParameters (ChannelNumberBuffer[0], BmcLanIp1SetupValues);
        }
    }
#if BMC_LAN_COUNT == 2
    ...
    if (ChannelNumberBuffer[1] != 0) {
        ...
        SetIpAddressSource (ChannelNumberBuffer[1], BmcLanIp2SetupValues.BmcLan);

        // Configure Static address source parameters to BMC
        if (BmcLanIp2SetupValues.BmcLan == IpmiStaticAddress) {
            SetStaticBmcNetworkParameters (ChannelNumberBuffer[1], BmcLanIp2SetupValues );
        }
    }
#endif
