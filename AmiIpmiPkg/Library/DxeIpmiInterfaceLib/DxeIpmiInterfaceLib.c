  ...
  VOID )
{
    ...
    SERVER_IPMI_DEBUG ((DEBUG_INFO, "DxeIpmiInterfaceLib: gEfiDxeIpmiUsbTransportProtocolGuid Status: %r \n", Status));
}
  ...
  VOID )
{
    ...
    Status = gBS->LocateProtocol (
                ...
                NULL,
                (VOID **)&gIpmiTransport );
    SERVER_IPMI_DEBUG ((DEBUG_INFO, "DxeIpmiInterfaceLib: gEfiDxeIpmiTransportProtocolGuid Status: %r \n", Status));
}
  ...
  IN EFI_SYSTEM_TABLE  *SystemTable )
{
    ...
    //
    LocateIpmiProtocol ();
    SERVER_IPMI_DEBUG ((DEBUG_INFO, "DxeIpmiInterfaceLib: gIpmiTransport: %X \n", gIpmiTransport));

    //
    // Locate the IPMI USB transport protocol.
    //
    LocateIpmiUsbProtocol ();
    SERVER_IPMI_DEBUG ((DEBUG_INFO, "DxeIpmiInterfaceLib: gIpmiUsbTransport: %X \n", gIpmiUsbTransport));
