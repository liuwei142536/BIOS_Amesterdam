...
VOID * LocalPcdPciExpressBaseAddress = 0;
...
{
//Grangeville AptioV Server Override Start: Changes done for SerialDebugger support
#if defined(SERIAL_DEBUGGER_SUPPORT) && (SERIAL_DEBUGGER_SUPPORT == 1)
//CoreBus = 0 CoreDev = 5 CoreFunc = 0 IIOMMCFGB0 = 0x90
  	  IoWrite32 (0xCF8, 0x80000000 | (0 << 16) + (5 << 11) + (0 << 8) + 0x90);
	  LocalPcdPciExpressBaseAddress = (VOID *)(IoRead32 (0xCFC) & 0xFFFFFFF0);
  	  return RETURN_SUCCESS;
#else
      LocalPcdPciExpressBaseAddress = (VOID*)(UINTN) PcdGet64 (PcdPciExpressBaseAddress); 
  	  return RETURN_SUCCESS;
#endif
//Grangeville AptioV Server Override end: Changes done for SerialDebugger support
}
...
{
//AptioV server override start: Dynamic mmcfg base address change 
  if (LocalPcdPciExpressBaseAddress == 0)
    return (VOID*)(UINTN) PcdGet64 (PcdPciExpressBaseAddress);
	
  return LocalPcdPciExpressBaseAddress;
  //return (VOID*)(UINTN) PcdGet64 (PcdPciExpressBaseAddress);
//AptioV server override end: Dynamic mmcfg base address change   
}
