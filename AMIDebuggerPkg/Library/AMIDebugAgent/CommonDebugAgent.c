...
//<AMI_PHDR_START>
//----------------------------------------------------------------------------
//  Procedure:   IsUsb3Mode() 
//
//  Description: returns the USB_3_DEBUG_SUPPORT value.
//
//  Input:  
//
//  Output: 
...
//<AMI_PHDR_START>
//----------------------------------------------------------------------------
//  Procedure:   IsSerialMode() 
//
//  Description: returns the SERIAL_DEBUGGER_SUPPORT value.
//
//  Input:  
//
//  Output: 
...
{
#ifdef SERIAL_DEBUGGER_SUPPORT
    return SERIAL_DEBUGGER_SUPPORT;
#else
    return 0;
#endif
}
