...
//*****************************************************************//
//*****************************************************************//
// $Header: /AptioV/SRC/AMIDebugRx/DbgRxXportLib/XportHdr.c 10    6/15/15 3:53a Jekekumarg $
//
// $Revision: 10 $
//
// $Date: 6/15/15 3:53a $
...
// DebugPortUsb.c
// 
// 8     3/19/15 1:55a Jekekumarg
// [TAG]			EIP207752
// [Category]   	Bug Fix
// [Severity]		Important
// [Symptom]  	SMM Debugging not works after boot to UEFI OS
// [RootCause]	After Booting to OS debugger was making m_IsRuntime
// flag to TRUE and with in DEBUG_AGENT_INIT_ENTER_SMI case 
// if m_IsRuntime flag is TRUE then, debugger used to break without
// halting
// at SMM Entry.after removing this flag dependency also
// the Ehci controller seems to be disabled at this time that's why
// communication
// was not happening.
// [Solution]		removed m_IsRuntime flag dependency and 
// cleared the InUse Flag after write\read transaction 
// from debug port completes.
// [Files]			XportHdr.c
// 
