 ...
 */
VOID EFIAPI SetupNotificationFunction(IN EFI_EVENT Event, IN VOID *Context)
{
...
)
{
    ...
    AmiCallbackParameters.This = This;
    AmiCallbackParameters.Action = Action;
    AmiCallbackParameters.QuestionId = KeyValue;
    AmiCallbackParameters.Type = Type;
    AmiCallbackParameters.Value = Value;
    AmiCallbackParameters.ActionRequest = ActionRequest;
    AmiCallbackParameters.HiiHandle = FormData.HiiHandle;
