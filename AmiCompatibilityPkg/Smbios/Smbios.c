...
// EIP#674389
    ...
    //Save Smbios table start address to update WakeupType
    Status = SaveLockBox (&gSmbiosWakeupTypeUpdateGuid,
                          &SmbiosDataTable,
                          sizeof(SmbiosDataTable));
#endif
// APTIOV_OVERRIDE_END
...

{
    ...
    if (Status == EFI_SUCCESS) {
        ...
        pEdkiiVariableLockProtocol->RequestToLock(pEdkiiVariableLockProtocol,
                                                  ...
                                                  &gAmiSmbiosNvramGuid);
        //APTIOV_OVERRIDE_START: SA50072 Latest update
        // EIP#654750
        pEdkiiVariableLockProtocol->RequestToLock(pEdkiiVariableLockProtocol,
