  ...
  )
{
  IHANDLE             *Handle;
  //*** AMI PORTING BEGIN ***//
  // Enhancement: see comments below
  // LIST_ENTRY          *Link;
  //*** AMI PORTING END *****//
  ...
  //*** AMI PORTING BEGIN ***//
  // Enhancement: Original implementation is very slow.
  // On server projects will large number of handles it adds up to 1.5 sec. into a boot process.
  // Switch back to an older implementation that just checks the signature.
  /*
