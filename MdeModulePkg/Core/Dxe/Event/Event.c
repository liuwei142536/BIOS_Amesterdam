  ...
  )
{
  ...
  while (!IsListEmpty (Head)) {
    ...
    //*** AMI PORTING BEGIN ***//
    DEBUG((DEBUG_EVENT, "Calling Notify Function %p; Type = 0x%X\n", Event->NotifyFunction, Event->Type));
    //*** AMI PORTING END *****//
  ...
  )
{
  ...
  *Event = IEvent;
  //*** AMI PORTING BEGIN ***//
  DEBUG((DEBUG_EVENT, "Registering Notify Function %p; Type = 0x%X\n", IEvent->NotifyFunction, IEvent->Type));
  //*** AMI PORTING END *****//
