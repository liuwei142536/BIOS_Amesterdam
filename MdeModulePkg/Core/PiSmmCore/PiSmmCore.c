...
// To enable SmmCommunicate on legacy boot, we are not setting mInLegacyBoot flag
// (one line is commented below in SmmLegacyBootHandler).
//*** AMI PORTING END *****//
  ...
  )
{
  ...
  //*** AMI PORTING BEGIN ***//
  // Do not set mInLegacyBoot flag. See AMI comments above prior to mInLegacyBoot declaration.
  // mInLegacyBoot = TRUE;
  //*** AMI PORTING END *****//
...
//*** AMI PORTING BEGIN ***//
  DEBUG ((DEBUG_EVENT, "SmmEntryPoint Entry\n"));
//*** AMI PORTING END *****//
  //
...
//*** AMI PORTING BEGIN ***//
  DEBUG ((DEBUG_EVENT, "SmmEntryPoint Exit\n"));
//*** AMI PORTING END *****//
}
