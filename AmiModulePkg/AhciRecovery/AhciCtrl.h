...
#define         HBA_PORTS_IS_DHRS               BIT0
#define         HBA_PORTS_IS_PSS                BIT1
#define         HBA_PORTS_IS_SSS                BIT2
#define         HBA_PORTS_IS_SDBS               BIT3
#define         HBA_PORTS_IS_UFS                BIT4
#define         HBA_PORTS_IS_DPS                BIT5
#define         HBA_PORTS_IS_PCS                BIT6
#define         HBA_PORTS_IS_DIS                BIT7
