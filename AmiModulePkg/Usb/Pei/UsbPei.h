...
#define USB_PEI_PCD_TYPE_BOOLEAN    0x01
#define USB_PEI_PCD_TYPE_UINT8      0x02
#define USB_PEI_PCD_TYPE_UINT16     0x03
#define USB_PEI_PCD_TYPE_UINT32     0x04
#define USB_PEI_PCD_TYPE_UINT64     0x05
#define USB_PEI_PCD_TYPE_VOID       0x06

// Pei USB feature equates
#define USB_UHCI_PEI_SUPPORT             0x0001          // BIT 0
#define USB_OHCI_PEI_SUPPORT             0x0002          // BIT 1
#define USB_EHCI_PEI_SUPPORT             0x0004          // BIT 2
#define USB_XHCI_PEI_SUPPORT             0x0008          // BIT 3
#define USB_HOST_ERROR_SUPPORT           0x0010          // BIT 4



#define USB_PEI_KB_NUMLOCK                    1
#define MAX_USB_PEI_UHCI_HOST                 0x05
#define MAX_USB_PEI_EHCI_HOST                 0x05
#define MAX_USB_PEI_XHCI_HOST                 0x05
#define MAX_USB_PEI_OHCI_HOST                 0x05
#define MAX_USB_PEI_XHCI_REG_INIT_COUNT       0x40
#define MAX_USB_PEI_OHCI_REG_INIT_COUNT       0x40
#define MAX_KEY_MODIIFIER                     0x06
...
typedef struct _PCD_PEI_INFO_INIT_TABLE PCD_PEI_INFO_INIT_TABLE;
struct _PCD_PEI_INFO_INIT_TABLE{
    UINTN   TokenName;
    UINT32  *MemAddr;
    UINTN   Value;
    UINT8   Type;
...
typedef struct _USB_PEI_TIMING_POLICY USB_PEI_TIMING_POLICY;
struct _USB_PEI_TIMING_POLICY {
    UINT8     RecReqTimeout;
    UINT8     DevConnectTimeout;
    UINT8     KbConnectDelay;
};

typedef struct _USB_PEI_GLOBAL_DATA USB_PEI_GLOBAL_DATA;
struct _USB_PEI_GLOBAL_DATA{
    UINT32                   UsbPeiFeature;
    USB_PEI_TIMING_POLICY    TimingPolicy;
    
    // UHCI Controller    
    PCI_BUS_DEV_FUNCTION     UhciPciDev[MAX_USB_PEI_UHCI_HOST];
    UINT8                    UhciHcCount;
    UINT16                   UhciIoBase;

    // OHCI Controller
    PCI_BUS_DEV_FUNCTION     OhciPciDev[MAX_USB_PEI_OHCI_HOST];
    UINT8                    OhciHcCount;
    PCI_DEV_REGISTER_VALUE   OhciRegTbl[MAX_USB_PEI_OHCI_REG_INIT_COUNT];
    UINT8                    OhciRegInitCount;
    UINT32                   OhciIoBase;

    // EHCI Controller
    PCI_BUS_DEV_FUNCTION     EhciPciDev[MAX_USB_PEI_EHCI_HOST];
    UINT8                    EhciHcCount;
    UINTN                    EhciIoResource[MAX_USB_PEI_EHCI_HOST];

    // XHCI Controller
    PCI_BUS_DEV_FUNCTION     XhciPciDev[MAX_USB_PEI_XHCI_HOST];
    UINT8                    XhciHcCount;
    PCI_DEV_REGISTER_VALUE   XhciRegTbl[MAX_USB_PEI_XHCI_REG_INIT_COUNT];
    UINT8                    XhciRegInitCount;
    UINT32                   XhciIoBase;
    UINT32                   XhciMmioSize;

    UINT8                    RecoveryReqRet;
    UINT8                    KeyModifierVal[MAX_KEY_MODIIFIER];
    UINT8                    ModifierBitsCount;
    UINT8                    RecoveryScanCode;
};
#pragma pack()
