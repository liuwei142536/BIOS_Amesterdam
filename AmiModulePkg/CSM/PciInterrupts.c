...
)
{
    ...
    Status = pBS->LocateProtocol (&gEfiLegacyInterruptProtocolGuid, NULL, (VOID**)&iInterrupt);
    ...
    ASSERT(IrqIndex < sizeof(irq_priority_map));
    if (IrqIndex >= sizeof(irq_priority_map)) return EFI_NOT_FOUND;
...
VOID EFIAPI PciIoNotifyCallback (
    EFI_EVENT Event,
    VOID      *Context)
{
//  UINT16      counter;
