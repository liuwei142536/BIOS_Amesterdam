...
VOID EFIAPI CsmBlockIoComebackFromLegacyBoot(EFI_EVENT, VOID*);
...
)
{
    ...
    if (irq > 0 && irq < 0xF) {
        Status = pBS->LocateProtocol(&gEfiLegacy8259ProtocolGuid, NULL, (VOID**)&i8259);
        ASSERT_EFI_ERROR(Status);
