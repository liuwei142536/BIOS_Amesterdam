...
/** @file PciSetup.h
    Definition of SETUP Data fields.
...
typedef struct _PCI_HP_SETUP_DATA{
    ///Hotplug Related Settings visible if PCI_HOTPLUG_SUPPORT == 1 && PCI_EXPRESS_SUPPORT == 1
...
//---------------------------------------------------------------------------------
///Structure Defines PCI Related data stored in GLOBAL SETUP_DATA NVRAM variable
