...
UINT8             AmiKey22Hash[SHA256_DIGEST_SIZE]={
  0x73, 0xda, 0xc8, 0x00, 0xc7, 0x6b, 0xea, 0x79, 0xcf, 0xb8, 0xf5, 0x02, 0x88, 0x79, 0x9f, 0x83,
  0xbd, 0xd2, 0xf3, 0x5d, 0x42, 0x0b, 0xda, 0x74, 0x50, 0x9a, 0xc0, 0x54, 0xbc, 0x12, 0x71, 0x08
...
/**
    Update Secure Flash Browser Info
...
// x509 hash of full Cert file
    ...
    if(SecureFlashSetupVar.Mode) {
        ...
        SecureFlashSetupVar.Rollback = 1; // disabled
#else
