...
#define VID_IIOCB_FUNC4_REG 0x11042000
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       HSX (0x20024002)                                                     */
/*       BDX (0x20024002)                                                     */
/* Register default value on IVT_EP:    0x0E24                                */
/* Register default value on IVT_EX:    0x0E24                                */
/* Register default value on HSX:       0x2F24                                */
/* Register default value on BDX:       0x6F24                                */
#define DID_IIOCB_FUNC4_REG 0x11042002
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
typedef union {
  struct {
    ...
    /* device_identification_number - Bits[15:0], RO, default = 16'b0110111100100100 
...
#define PCICMD_IIOCB_FUNC4_REG 0x11042004
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define PCISTS_IIOCB_FUNC4_REG 0x11042006
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define RID_IIOCB_FUNC4_REG 0x11041008
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x10024009)                                                     */
/* Register default value:              0x00                                  */
#define CCR_N0_IIOCB_FUNC4_REG 0x11041009


#if defined(HSX_HOST) || defined(BDX_HOST)
#ifndef ASM_INC
/* Struct format extracted from XML file HSX\0.4.4.CFG.xml.
...
typedef union {
  ...
  UINT8 Data;
} CCR_N0_IIOCB_FUNC4_HSX_BDX_STRUCT;
#endif /* ASM_INC */
...
#define CCR_N1_IIOCB_FUNC4_REG 0x1104200A
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
 * PCIe header ClassCode register
 */
...
/*       BDX (0x1002400C)                                                     */
/* Register default value:              0x00                                  */
#define CLSR_IIOCB_FUNC4_REG 0x1104100C
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define HDR_IIOCB_FUNC4_REG 0x1104100E
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define CB_BAR_0_IIOCB_FUNC4_REG 0x11044010
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define CB_BAR_1_IIOCB_FUNC4_REG 0x11044014
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x2002402C)                                                     */
/* Register default value:              0x8086                                */
#define SVID_IIOCB_FUNC4_REG 0x1104202C
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x2002402E)                                                     */
/* Register default value:              0x0000                                */
#define SDID_IIOCB_FUNC4_REG 0x1104202E
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x10024034)                                                     */
/* Register default value:              0x80                                  */
#define CAPPTR_IIOCB_FUNC4_REG 0x11041034
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x1002403C)                                                     */
/* Register default value:              0x00                                  */
#define INTL_IIOCB_FUNC4_REG 0x1104103C
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define INTPIN_IIOCB_FUNC4_REG 0x1104103D
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define MSIXCAPID_IIOCB_FUNC4_REG 0x11041080
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define MSIXNXTPTR_IIOCB_FUNC4_REG 0x11041081
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x20024082)                                                     */
/* Register default value:              0x0000                                */
#define MSIXMSGCTL_IIOCB_FUNC4_REG 0x11042082
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define TABLEOFF_BIR_IIOCB_FUNC4_REG 0x11044084
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define PBAOFF_BIR_IIOCB_FUNC4_REG 0x11044088
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define CAPID_IIOCB_FUNC4_REG 0x11041090
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/* NEXTPTR_IIOCB_FUNC4_REG supported on:                                      */
/*       IVT_EP (0x10024091)                                                  */
/*       IVT_EX (0x10024091)                                                  */
/*       HSX (0x10024091)                                                     */
/*       BDX (0x10024091)                                                     */
/* Register default value:              0xE0                                  */
#define NEXTPTR_IIOCB_FUNC4_REG 0x11041091
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
 * The PCI Express Capability List register enumerates the PCI Express Capability 
 * structure in the PCI 3.0 configuration space 
...
#define EXPCAP_IIOCB_FUNC4_REG 0x11042092
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define DEVCAP_IIOCB_FUNC4_REG 0x11044094
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define DEVCON_IIOCB_FUNC4_REG 0x11042098
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x2002409A)                                                     */
/* Register default value:              0x0000                                */
#define DEVSTS_IIOCB_FUNC4_REG 0x1104209A
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define DEVCAP2_IIOCB_FUNC4_REG 0x110440B4
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x200240B8)                                                     */
/* Register default value:              0x0000                                */
#define DEVCON2_IIOCB_FUNC4_REG 0x110420B8
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define PMCAP_IIOCB_FUNC4_REG 0x110440E0
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
#define PMCSR_IIOCB_FUNC4_REG 0x110440E4
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x40024180)                                                     */
/* Register default value:              0x00000000                            */
#define CHANERR_INT_IIOCB_FUNC4_REG 0x11044180
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x40024184)                                                     */
/* Register default value:              0x00000000                            */
#define CHANERRMSK_INT_IIOCB_FUNC4_REG 0x11044184
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x40024188)                                                     */
/* Register default value:              0x00000000                            */
#define CHANERRSEV_INT_IIOCB_FUNC4_REG 0x11044188
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
...
/*       BDX (0x1002418C)                                                     */
/* Register default value:              0x00                                  */
#define CHANERRPTR_IIOCB_FUNC4_REG 0x1104118C
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.4.CFG.xml.
