...
#define VID_IIOCB_FUNC2_REG 0x11022000
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       HSX (0x20022002)                                                     */
/*       BDX (0x20022002)                                                     */
/* Register default value on IVT_EP:    0x0E22                                */
/* Register default value on IVT_EX:    0x0E22                                */
/* Register default value on HSX:       0x2F22                                */
/* Register default value on BDX:       0x6F22                                */
#define DID_IIOCB_FUNC2_REG 0x11022002
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
typedef union {
  struct {
    ...
    /* device_identification_number - Bits[15:0], RO, default = 16'b0110111100100010 
...
#define PCICMD_IIOCB_FUNC2_REG 0x11022004
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define PCISTS_IIOCB_FUNC2_REG 0x11022006
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define RID_IIOCB_FUNC2_REG 0x11021008
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x10022009)                                                     */
/* Register default value:              0x00                                  */
#define CCR_N0_IIOCB_FUNC2_REG 0x11021009


#if defined(HSX_HOST) || defined(BDX_HOST)
#ifndef ASM_INC
/* Struct format extracted from XML file HSX\0.4.2.CFG.xml.
...
typedef union {
  ...
  UINT8 Data;
} CCR_N0_IIOCB_FUNC2_HSX_BDX_STRUCT;
#endif /* ASM_INC */
...
#define CCR_N1_IIOCB_FUNC2_REG 0x1102200A
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
 * PCIe header ClassCode register
 */
...
/*       BDX (0x1002200C)                                                     */
/* Register default value:              0x00                                  */
#define CLSR_IIOCB_FUNC2_REG 0x1102100C
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define HDR_IIOCB_FUNC2_REG 0x1102100E
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define CB_BAR_0_IIOCB_FUNC2_REG 0x11024010
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define CB_BAR_1_IIOCB_FUNC2_REG 0x11024014
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x2002202C)                                                     */
/* Register default value:              0x8086                                */
#define SVID_IIOCB_FUNC2_REG 0x1102202C
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x2002202E)                                                     */
/* Register default value:              0x0000                                */
#define SDID_IIOCB_FUNC2_REG 0x1102202E
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x10022034)                                                     */
/* Register default value:              0x80                                  */
#define CAPPTR_IIOCB_FUNC2_REG 0x11021034
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x1002203C)                                                     */
/* Register default value:              0x00                                  */
#define INTL_IIOCB_FUNC2_REG 0x1102103C
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define INTPIN_IIOCB_FUNC2_REG 0x1102103D
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define MSIXCAPID_IIOCB_FUNC2_REG 0x11021080
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define MSIXNXTPTR_IIOCB_FUNC2_REG 0x11021081
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x20022082)                                                     */
/* Register default value:              0x0000                                */
#define MSIXMSGCTL_IIOCB_FUNC2_REG 0x11022082
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define TABLEOFF_BIR_IIOCB_FUNC2_REG 0x11024084
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define PBAOFF_BIR_IIOCB_FUNC2_REG 0x11024088
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define CAPID_IIOCB_FUNC2_REG 0x11021090
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/* NEXTPTR_IIOCB_FUNC2_REG supported on:                                      */
/*       IVT_EP (0x10022091)                                                  */
/*       IVT_EX (0x10022091)                                                  */
/*       HSX (0x10022091)                                                     */
/*       BDX (0x10022091)                                                     */
/* Register default value:              0xE0                                  */
#define NEXTPTR_IIOCB_FUNC2_REG 0x11021091
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
 * The PCI Express Capability List register enumerates the PCI Express Capability 
 * structure in the PCI 3.0 configuration space 
...
#define EXPCAP_IIOCB_FUNC2_REG 0x11022092
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define DEVCAP_IIOCB_FUNC2_REG 0x11024094
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define DEVCON_IIOCB_FUNC2_REG 0x11022098
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x2002209A)                                                     */
/* Register default value:              0x0000                                */
#define DEVSTS_IIOCB_FUNC2_REG 0x1102209A
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define DEVCAP2_IIOCB_FUNC2_REG 0x110240B4
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x200220B8)                                                     */
/* Register default value:              0x0000                                */
#define DEVCON2_IIOCB_FUNC2_REG 0x110220B8
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define PMCAP_IIOCB_FUNC2_REG 0x110240E0
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
#define PMCSR_IIOCB_FUNC2_REG 0x110240E4
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x40022180)                                                     */
/* Register default value:              0x00000000                            */
#define CHANERR_INT_IIOCB_FUNC2_REG 0x11024180
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x40022184)                                                     */
/* Register default value:              0x00000000                            */
#define CHANERRMSK_INT_IIOCB_FUNC2_REG 0x11024184
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x40022188)                                                     */
/* Register default value:              0x00000000                            */
#define CHANERRSEV_INT_IIOCB_FUNC2_REG 0x11024188
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
...
/*       BDX (0x1002218C)                                                     */
/* Register default value:              0x00                                  */
#define CHANERRPTR_IIOCB_FUNC2_REG 0x1102118C
#ifndef ASM_INC
/* Struct format extracted from XML file BDX\0.4.2.CFG.xml.
