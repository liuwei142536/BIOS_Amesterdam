...
/**
  ...
  @param socket            - Socket number
  @param ch                - Channel number
  @param NumberOfWdbLines  - The number of cachelines to save
        ...
        )
{
  ...
  // Compare cached values
  if (MemCompare((UINT8 *)&(*channelList)[ch].WdbLines[0], (UINT8 *)&(*channelList)[ch].WdbLinesBackup[0], sizeof(TWdbLine) * NumberOfWdbLines)) {

    // Update cached values
    MemCopy((UINT8 *)&(*channelList)[ch].WdbLinesBackup[0], (UINT8 *)&(*channelList)[ch].WdbLines[0], sizeof(TWdbLine) * NumberOfWdbLines);
  }
}
           ...
           )
{
  ...
  if (MemCompare((UINT8 *)&(*channelList)[ch].WdbLines[0], (UINT8 *)&(*channelList)[ch].WdbLinesBackup[0], sizeof(TWdbLine) * NumberOfWdbLines)) {
    ...
    // Fill the WDB
    //
    WdbPreLoadChip (host, socket, ch, NumberOfWdbLines, (void *)&(*channelList)[ch].WdbLinesBackup[0], 0);

    // Update cached values
    MemCopy((UINT8 *)&(*channelList)[ch].WdbLines[0], (UINT8 *)&(*channelList)[ch].WdbLinesBackup[0], sizeof(TWdbLine) * NumberOfWdbLines);
