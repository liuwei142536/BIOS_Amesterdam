...
void MemSetLocal(UINT8 *dest, UINT32 value, UINT32 numBytes);
UINT32 MemScan(UINT8 *dest, UINT32 value, UINT32 numBytes);
void MemCopy(UINT8 *dest, UINT8 *src, UINT32 numBytes);
UINT32 MemCompare(UINT8 *dest, UINT8 *src, UINT32 numBytes);
