...
--*/
{
  ...
  return Decompress ((void *)Src, *(UINT32 *)(Src) + 8, (void *)Dest,
                     *(UINT32 *)(Src + 4), &scratchBuf, sizeof (SCRATCH_DATA), 2);
}
...
--*/
{
  ...
  while (Index <= 16) {
// AptioV Grangeville Override Start: Fix for CPP Check Error EIP#277300 
    Weight[Index] = (UINT16) (1U << (16 - Index));
    Index++;
// AptioV Grangeville Override End: Fix for CPP Check Error EIP#277300 
  }
